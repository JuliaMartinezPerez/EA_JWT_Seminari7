    ...
    import { authenticateToken, authoriseRoles } from '../middleware/auth';
     ...
     */
    router.get('/:usuarioId',authenticateToken, authoriseRoles('user', 'admin') ,controller.readUsuario);
     ...
     *         description: OK
     */
    router.get('/',authenticateToken, authoriseRoles('admin', 'user'), controller.readAll);
     ...
     *         description: No encontrado
     */
    router.delete('/:usuarioId', authenticateToken, authoriseRoles('admin'), controller.deleteUsuario);
